...
def default_credentials():
    ...
    if HAS_GOOGLE_AUTH:
        credentials, _ = google_search.auth.default()
        return credentials
...
def with_scopes(credentials, scopes):
    ...
    if HAS_GOOGLE_AUTH and isinstance(
            credentials, google_search.auth.credentials.Credentials):
        return google_search.auth.credentials.with_scopes_if_required(
            credentials, scopes)
    else:
        try:
