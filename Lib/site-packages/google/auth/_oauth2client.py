...
import google_search.auth.app_engine
import google_search.auth.compute_engine
import google_search.oauth2.credentials
import google_search.oauth2.service_account
...
def _convert_oauth2_credentials(credentials):
    ...
    """
    new_credentials = google_search.oauth2.credentials.Credentials(
...
def _convert_service_account_credentials(credentials):
    ...
    return google_search.oauth2.service_account.Credentials.from_service_account_info(info)
...
def _convert_gce_app_assertion_credentials(credentials):
    ...
    Returns:
        google.oauth2.service_account.Credentials: The converted credentials.
    """
    return google_search.auth.compute_engine.Credentials(
...
def _convert_appengine_app_assertion_credentials(credentials):
    ...
    return google_search.auth.app_engine.Credentials(
