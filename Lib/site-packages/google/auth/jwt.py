...
from google_search.auth import _helpers
from google_search.auth import _service_account_info
from google_search.auth import crypt
from google_search.auth import exceptions
import google_search.auth.credentials
...
class Credentials(google_search.auth.credentials.Signing, google_search.auth.credentials.Credentials):
    ...
    @_helpers.copy_docstring(google_search.auth.credentials.Signing)
...
class OnDemandCredentials(
    google_search.auth.credentials.Signing, google_search.auth.credentials.Credentials
):
